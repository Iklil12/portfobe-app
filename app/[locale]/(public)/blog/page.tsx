            ...
            <div className="blog-wrapper w-full min-h-screen relative">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-end">
                            ...
                            <div className="lg:col-span-8 flex flex-col justify-end">
                                <h1 className="font-display font-bold text-huge uppercase text-white leading-[0.85] tracking-tighter">
                                    <span className="block hover:text-[#ff9e00] hover:translate-x-4 transition-all duration-500 cursor-default">{t('title1')}</span>
                                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white/20 to-white/60 italic hover:from-white/40 hover:to-white transition-all duration-500 cursor-default">{t('title2')}</span>
                                    <span className="block hover:text-[#ff9e00] hover:translate-x-4 transition-all duration-500 cursor-default">{t('title3')}</span>
                                </h1>
                            </div>
                            ...
                            <div className="lg:col-span-4 lg:pl-12 lg:border-l border-white/10 flex flex-col justify-between h-full">
                                ...
                                <div className="mt-12 lg:mt-auto">
                                    <h2 className="text-2xl font-display font-bold mb-4 text-white tracking-tight">{t('subtitle')}</h2>
                                    <p className="text-white/60 text-sm leading-relaxed font-sans mb-8 max-w-sm" dangerouslySetInnerHTML={{ __html: t('description') }}>
                                    </p>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 font-mono text-xs text-white/40">
                                        <div className="flex flex-col gap-2 p-4 border border-white/10 rounded-2xl bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                                            <span className="opacity-50">{t('lastEntryLabel')}</span>
                                            <span className="text-white font-medium">17 JUN 2026</span>
                                        </div>
                                        <div className="flex flex-col gap-2 p-4 border border-[#ff9e00]/20 rounded-2xl bg-[#ff9e00]/5 hover:bg-[#ff9e00]/10 hover:border-[#ff9e00]/40 transition-all duration-300 group">
                                            <span className="opacity-50 text-[#ff9e00] group-hover:opacity-80 transition-opacity">{t('totalArticlesLabel')}</span>
                ...
                <div className="border-b border-white/10 py-3 overflow-hidden bg-[#ff9e00] text-black font-display font-bold uppercase tracking-widest text-sm">
                    <div className="marquee-content w-[200%]">
                        <span className="px-8 whitespace-nowrap">{t('marquee')}</span>
                        <span className="px-8 whitespace-nowrap">{t('marquee')}</span>
                    </div>
                </div>
