            ...
            >
                <Link href={`/${subdomain}/gallery`}  className="w-full @md:w-auto">
                    <motion.div
                        whileHover="hover"
                        initial="initial"
                        className={`group flex items-center justify-center gap-3 px-12 py-4.5 ${btnShape} border border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--primary)] hover:text-[#050505] transition-all duration-300 cursor-pointer uppercase font-black tracking-[0.3em] text-xs @sm:text-sm w-full @md:min-w-[320px]`}
                    >
