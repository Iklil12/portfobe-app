...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Membedah Arsitektur SEO "Stealth Sitemap"',
    description: 'Bagaimana kami meninggalkan paradigma sitemap tradisional dan mengimplementasikan Stealth Sitemap Index.',
    url: 'https://portfo.be/blog/stealth-sitemap',
    siteName: 'Portfo.be',
    images: [
      {
        url: 'https://portfo.be/images/blog/stealth-sitemap-hero.png',
        width: 1200,
        height: 630,
        alt: 'Stealth Sitemap SEO Architecture Illustration',
      },
    ],
    locale: 'id_ID',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Membedah Arsitektur SEO "Stealth Sitemap"',
    description: 'Bagaimana kami meninggalkan paradigma sitemap tradisional dan mengimplementasikan Stealth Sitemap Index.',
    images: ['https://portfo.be/images/blog/stealth-sitemap-hero.png'],
  },
};
  ...
  return (
    <div className="font-sans min-h-screen bg-black text-white antialiased selection:bg-[#ff9e00] selection:text-black dark">
      ...
      <header className="pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/10 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-4 font-mono text-xs text-white/50 mb-6 uppercase tracking-widest">
            <span className="text-[#ff9e00]">ENGINEERING</span>
            <span>//</span>
      ...
      <article className="px-6 py-16 md:py-24 max-w-3xl mx-auto text-lg leading-relaxed text-white/80 font-sans">
        ...
        <p className="mb-12">
          Artikel ini membedah bagaimana kami meninggalkan paradigma sitemap tradisional dan mengimplementasikan <strong className="text-[#ff9e00]">Stealth Sitemap Index</strong>—sebuah teknik yang digunakan oleh raksasa seperti Linktree dan Notion untuk melindungi data sekaligus mendominasi mesin pencari.
        </p>
        ...
        <p className="mb-6">
          Dalam arsitektur web tradisional, Anda meletakkan file <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">sitemap.xml</code> di root directory. File ini berisi tautan ke halaman utama, halaman harga, dan (jika Anda memiliki platform user-generated content) seluruh profil pengguna Anda yang berstatus publik.
        </p>

        <p className="mb-6">Masalahnya muncul saat platform Anda tumbuh:</p>

        <ol className="list-decimal pl-6 space-y-4 mb-12 marker:text-[#ff9e00] marker:font-bold">
          <li><strong className="text-white">Pencurian Data (Scraping):</strong> Kompetitor atau bot jahat hanya perlu mengunjungi <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">/sitemap.xml</code> untuk mengekstrak seluruh daftar pengguna aktif Anda dalam hitungan detik.</li>
        ...
        <p className="mb-10">
          Jalur standar <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">/sitemap.xml</code> kami kunci. Jika diakses oleh browser biasa, server akan mengembalikan HTTP 404 (Not Found) atau hanya menampilkan rute halaman statis pemasaran, tanpa mengekspos profil pengguna.
        </p>

        <h3 className="font-display font-bold text-2xl text-white mt-10 mb-4">2. Memecah Node Data</h3>
        <p className="mb-6">
          Untuk data pengguna, kami men-generate rute URL acak yang sulit ditebak, misalnya <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">/api/seo/core-index-xyz.xml</code>. Di dalamnya, data tidak ditumpuk, melainkan dipecah (dipaginasi) setiap 10.000 URL.
        </p>
   ...
   <sitemap>
      ...
      <lastmod>2026-06-09T00:00:00+00:00</lastmod>
        ...
        <p className="mb-12">
          URL rahasia ini <strong>tidak pernah</strong> kami cantumkan di dalam <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">robots.txt</code>. Sebagai gantinya, kami mengirimkan URL spesifik tersebut secara langsung ke dashboard Google Search Console dan Bing Webmaster Tools. Mesin pencari tahu di mana harus mencari, tapi kompetitor akan kebingungan.
        </p>
        ...
        <p className="mb-8">
          Setiap kali status <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">isLive</code> di database berubah menjadi <code className="bg-white/10 px-2 py-1 rounded text-sm font-mono text-[#ff9e00]">true</code>, Node.js secara asinkron (fire-and-forget) mengirimkan paket Ping ke jaringan IndexNow. Ini memaksa Bing, Yahoo, dan Yandex untuk langsung merayapi URL spesifik tersebut tanpa harus menunggu jadwal baca sitemap bulanan.
        </p>
...
if (isLive && subdomain) {
  ...
  pingIndexNow(urlToPing).catch(console.error);
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-wrap items-center justify-between gap-4">
          ...
          <ShareButton
            title='Membedah Arsitektur SEO "Stealth Sitemap" Skala Enterprise'
            text='Baca bagaimana Portfo.be mengimplementasikan arsitektur Stealth Sitemap Index untuk SEO skala besar.'
            image='/images/blog/stealth-sitemap-hero.png'
          />
        </div>
      </article>
