  ...
  return (
    <main className="min-h-screen relative overflow-hidden selection:bg-[#ff9e00]/30 selection:text-white pb-24">
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-10 relative z-10">
        ...
        <div className="bg-zinc-900/40 p-6 sm:p-10 md:p-12 rounded-md border border-white/10 shadow-none transition-all duration-500 relative animate-enter overflow-hidden" style={{animationDelay: '200ms'}}>
