    ...
    return (
        <section className="w-full py-32 px-6 md:px-16 bg-[#030303]">
            <h2 className="text-5xl md:text-7xl font-serif text-white/90 mb-16 text-center italic">
                <EditableText entity="appearance" field="cinematic_skills_title" value={getCustomText('cinematic_skills_title', 'Core Capabilities')} isEditor={isEditor} maxLength={40} as="span" />
            </h2>
                ...
                {skills.map((skill: any, index: number) => {
                    ...
                    return (
                        <div key={index} className="flex flex-col items-center text-center mb-16 relative">
                            <div className="flex justify-between items-center mb-4 text-3xl font-serif text-white/90 mb-4">
                                <span>
                                    <EditableText 
                                        value={defaultName} 
                            ...
                            <div className={`w-full h-2 ${isEditor ? '' : 'overflow-hidden'} bg-white/10 w-full max-w-md mt-6`}>
                                <motion.div 
                                    initial={{ width: 0 }}
