...
import { safeParseJson, safeStringifyJson } from '@/shared/lib/safeJson';
...
export type useThemeEditorState = ReturnType<typeof useThemeEditor>['state'];
export type useThemeEditorActions = ReturnType<typeof useThemeEditor>['actions'];
