            ...
            <div className={`grid grid-cols-1 @md:grid-cols-2 gap-8 @md:gap-16 @lg:gap-24`}>
                {items3D.map((p: any, i: number) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-full aspect-[4/5] sm:aspect-square ${cardRadiusClass} overflow-hidden relative mb-6 @md:mb-8 ${cardStyleClassLight} group-hover:-translate-y-2 transition-all duration-700`}>
