    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 py-10 selection:bg-[#ff9e00]/35 selection:text-white pb-32">
      ...
      <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-sans font-medium uppercase tracking-wider text-white mb-2">{t('title')}<span className="text-white/60 font-light">{t('titleHighlight')}</span>
          </h1>
          <p className="text-xs font-sans text-white/50">{t('desc')}</p>
        </div>
      ...
      <div className="bg-zinc-950 border border-white/10 rounded-md overflow-hidden">
        ...
        {isLoading ? (
          ...
          <div className="py-24 flex flex-col items-center justify-center text-center px-6">
             ...
             <p className="text-sm font-sans font-medium text-white">{t('notFound')}</p>
             <p className="text-xs font-sans text-white/60 mt-1 mb-8">{t('noResults', { query: searchQuery })}</p>
      ...
      {!isLoading && filteredActivities.length > 0 && (
        <p className="text-center mt-10 text-[9px] font-sans font-medium text-white/50 tracking-[0.2em]"> {t('endOfLog', { count: filteredActivities.length })}</p>
      )}
    </main>
  );
}
