  ...
  return (
    <div className="max-w-5xl mx-auto mt-24 p-8 md:p-12 border border-white/10 bg-zinc-950">
      <div className="text-center mb-10">
        <h2 className="text-2xl md:text-3xl font-sans font-medium text-white mb-3">Subscription Details & Advantages 🎁</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-8 border border-white/10 bg-black/40">
          ...
          <h3 className="text-lg font-sans font-medium text-white mb-4">Monthly Subscription</h3>
        ...
        <div className="p-8 border border-[#ff9e00]/20 bg-white/[0.02] relative overflow-hidden">
          ...
          <h3 className="text-lg font-sans font-medium text-white mb-4">Yearly Subscription</h3>
