    ...
    `}>
      <div className="flex flex-col h-full w-full">
        <div className="h-[88px] shrink-0 flex items-center justify-center border-b border-transparent px-6 transition-all relative">
          {isLoading ? (
            ...
            <Link href="/" className="flex items-center group cursor-pointer w-full justify-center relative h-full">
               <div className={`absolute inset-0 flex items-center justify-center transition-all ease-[cubic-bezier(0.22,1,0.36,1)] ${shouldCollapse ? 'opacity-100 scale-100 rotate-0 duration-500 delay-150' : 'opacity-0 scale-50 -rotate-90 pointer-events-none duration-200 delay-0'}`}>
               ...
               <img src="/portfo.be.png" alt="Portfo.be Logo" className={`h-7 w-auto object-contain transition-all ease-[cubic-bezier(0.22,1,0.36,1)] ${shouldCollapse ? 'opacity-0 scale-50 rotate-90 pointer-events-none absolute duration-200 delay-0' : 'opacity-100 scale-100 rotate-0 group-hover:scale-105 mr-auto duration-500 delay-150'}`} />
            </Link>
          )}
        </div>

        <nav className={`flex-1 space-y-1 mt-4 transition-all ${shouldCollapse ? 'overflow-visible px-3' : 'overflow-y-auto hide-scrollbar px-4'}`}>
          {isLoading ? (
            ...
            <>
              <div className="relative group/tooltip">
                <Link href="/dashboard" className={`w-full flex items-center py-3.5 rounded-2xl transition-all duration-300 group ${isActive('/dashboard') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 gap-0' : 'px-4 gap-4'}`}>
                  ...
                  <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Overview</span>
                </Link>
              ...
              <div className="pt-2 relative group/design">
                <button onClick={() => { if(!shouldCollapse) setIsDesignMenuOpen(!isDesignMenuOpen); }} className={`w-full flex items-center transition-all duration-300 group py-3.5 rounded-2xl ${isDesignRoute ? (shouldCollapse ? 'bg-slate-100 text-slate-900' : 'text-slate-900') : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 cursor-default' : 'px-4 justify-between'}`}>
                  <div className={`flex items-center transition-all duration-300 ${shouldCollapse ? 'gap-0' : 'gap-4'}`}>
                    ...
                    <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Desain</span>
                  </div>
                  <i className={`fas fa-chevron-down text-[10px] text-slate-400 transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${isDesignMenuOpen ? 'rotate-180' : ''} ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[20px] opacity-100 duration-500 delay-150'}`}></i>
                </button>
              ...
              <div className="relative group/tooltip">
                <Link href="/dashboard/analytics" className={`w-full flex items-center py-3.5 rounded-2xl transition-all duration-300 group mt-2 ${isActive('/dashboard/analytics') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 gap-0' : 'px-4 gap-4'}`}>
                  ...
                  <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Metrics</span>
                </Link>
              ...
              <div className={`px-5 transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-h-0 opacity-0 pt-0 pb-0 duration-200 delay-0' : 'max-h-[50px] opacity-100 pt-8 pb-3 duration-500 delay-150'}`}>
                <p className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest whitespace-nowrap">Pengaturan</p>
              </div>
              <div className={`w-full flex justify-center transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-h-[50px] opacity-100 pt-6 pb-2 duration-500 delay-150' : 'max-h-0 opacity-0 pt-0 pb-0 duration-200 delay-0'}`}>
              ...
              <div className="relative group/tooltip">
                <Link href="/dashboard/profile" className={`w-full flex items-center py-3.5 rounded-2xl transition-all duration-300 group ${isActive('/dashboard/profile') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 gap-0' : 'px-4 gap-4'}`}>
                  ...
                  <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Profil & Bio</span>
                </Link>
              ...
              <div className="relative group/tooltip">
                <Link href="/support" className={`w-full flex items-center py-3.5 rounded-2xl transition-all duration-300 group ${isActive('/support') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 gap-0' : 'px-4 gap-4'}`}>
                  ...
                  <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Bantuan</span>
                </Link>
              ...
              <div className="relative group/tooltip">
                <Link href="/dashboard/settings" className={`w-full flex items-center py-3.5 rounded-2xl transition-all duration-300 group ${isActive('/dashboard/settings') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'} ${shouldCollapse ? 'justify-center px-0 gap-0' : 'px-4 gap-4'}`}>
                  ...
                  <span className={`font-extrabold text-[13px] tracking-wide whitespace-nowrap transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-w-0 opacity-0 duration-200 delay-0' : 'max-w-[200px] opacity-100 duration-500 delay-150'}`}>Akun</span>
                </Link>
        ...
        <div className={`shrink-0 border-t border-slate-100 bg-white z-10 p-4 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]`}>
          <div className={`w-full transition-all ease-[cubic-bezier(0.22,1,0.36,1)] overflow-hidden ${shouldCollapse ? 'max-h-0 opacity-0 mb-0 duration-200 delay-0' : 'max-h-[300px] opacity-100 mb-4 duration-500 delay-150'}`}>
            {isLoading ? (
          ...
          <div className={`w-full flex transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${shouldCollapse ? 'justify-center' : 'justify-end'}`}>
            <button onClick={toggleSidebar} className="hidden md:flex w-10 h-10 rounded-xl bg-white border border-slate-200 text-slate-400 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-300 items-center justify-center transition-all duration-300 ease-in-out active:scale-90 group shadow-sm" title={shouldCollapse ? "Perbesar Sidebar" : "Perkecil Sidebar"}>
              <i className={`fas fa-chevron-left text-[12px] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${shouldCollapse ? 'rotate-180 group-hover:translate-x-0.5' : 'group-hover:-translate-x-0.5'}`}></i>
            </button>
          </div>
        </div>
      </div>
