                ...
                <form onSubmit={onSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="relative flex items-center">  
                      ...
                      <input type="password" required value={emailVerifyPassword} onChange={(e) => setEmailVerifyPassword(e.target.value)} className="w-full pl-11 pr-5 py-3 bg-zinc-950 border border-white/10 rounded-md text-xs font-sans text-white outline-none focus:border-[#ff9e00]/50 transition-all" placeholder="••••••••" />
                    </div>
                  </div>
