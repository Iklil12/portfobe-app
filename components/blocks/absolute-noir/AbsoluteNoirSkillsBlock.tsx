...
export function AbsoluteNoirSkillsBlock({ theme, isEditor }: any) {
    ...
    return (
        <section className="w-full py-32 px-4 md:px-12 bg-black @container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {skills.map((skill: any, index: number) => {
                    ...
                    return (
                        <div key={index} className="border border-white/20 p-6 @md:p-8 hover:bg-white hover:text-black transition-all duration-500 group relative">
                            <div className="flex justify-between items-start gap-4 mb-4 text-xl @md:text-2xl @lg:text-3xl font-bold uppercase">
                                ...
                                <span className="whitespace-nowrap shrink-0 flex items-center leading-none">
                                    <EditableText 
