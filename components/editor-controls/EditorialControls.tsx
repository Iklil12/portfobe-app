    ...
    <div className="animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-[10px] font-extrabold uppercase tracking-widest text-slate-500">Warna Aksen Editorial</h3>
        </div>
        <div className="flex flex-wrap gap-3">
          {['#2563eb', '#111111', '#c2410c', '#047857', '#b91c1c', '#6d28d9'].map(color => (
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-6 h-6 rounded-md bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400"><i className="fas fa-heading text-[10px]"></i></div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-6 h-6 rounded-md bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400"><i className="fas fa-align-left text-[10px]"></i></div>
