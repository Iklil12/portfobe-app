  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-hidden selection:bg-[#ff9e00]/30 selection:text-white">
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl bg-zinc-950 p-1 rounded-md border border-white/10 z-10 flex flex-col max-h-[92vh]"
      >
        ...
        <div className="bg-zinc-950 w-full border border-white/5 flex flex-col overflow-hidden h-full relative">
          ...
          <button
            onClick={handleCloseModal}
            className="absolute top-5 right-5 w-8 h-8 flex items-center justify-center rounded-md border border-white/10 text-white/50 hover:text-white hover:bg-white/5 transition-colors z-20 focus:outline-none"
          >
            <X className="w-4 h-4" />
          </button>
          ...
          <div className="overflow-y-auto custom-scrollbar w-full h-full relative z-10">
            <div className="p-6 sm:p-8 md:p-10">
              ...
              <div className="mb-8 pr-8">
                <h2 className="text-lg font-sans font-medium text-white uppercase tracking-wider">
                  {editingId ? 'Edit Data' : (projectType ? `${projectType === 'certificate' ? 'Certificate' : 'Project'} Detail` : 'Select Upload Type')}
                </h2>
                <p className="text-xs font-sans text-white/40 mt-1.5 leading-relaxed">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className={projectType === 'certificate' ? 'md:col-span-1' : 'md:col-span-2'}>
                        <label className="block text-[10px] font-sans font-medium uppercase tracking-widest text-white/40 mb-2 ml-1">{projectType === 'certificate' ? 'Certificate/Event' : 'Project'} Title <span className="text-rose-500">*</span></label>
                        <input
                          ...
                          className="w-full px-5 py-3.5 rounded-md border border-white/10 bg-zinc-900 focus:bg-zinc-950 focus:border-[#ff9e00] outline-none text-sm font-sans text-white transition-all duration-300 placeholder:text-white/30"
                          required
                        />
                      </div>
                      ...
                      {projectType === 'certificate' && (
                        <>
                          <div className="md:col-span-1">
                            <label className="block text-[10px] font-sans font-medium uppercase tracking-widest text-white/40 mb-2 ml-1">Achievement / Status <span className="text-rose-500">*</span></label>
                            <input
                          ...
                          <div className="md:col-span-1">
                            <label className="block text-[10px] font-sans font-medium uppercase tracking-widest text-white/40 mb-2 ml-1">Issuer / Organizer <span className="text-rose-500">*</span></label>
                            <input
                          ...
                          <div className="md:col-span-1">
                            <label className="block text-[10px] font-sans font-medium uppercase tracking-widest text-white/40 mb-2 ml-1">Year <span className="text-rose-500">*</span></label>
                            <input
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-[10px] font-sans font-medium uppercase tracking-widest text-white/40 mb-2 ml-1">
                        ...
                        {projectType === '3d' ? (
                          <div className="w-full">
                            ...
                            <div 
                              ...
                              onDrop={handleDrop}
                              className={`cursor-pointer border border-dashed transition-all duration-300 rounded-md flex flex-col items-center justify-center overflow-hidden relative min-h-[160px] w-full group/upload ${isDragActive ? 'border-[#ff9e00] bg-[#ff9e00]/10 shadow-[0_0_15px_rgba(255,158,0,0.15)]' : 'border-white/10 hover:border-[#ff9e00]/60 bg-zinc-900/30 hover:bg-zinc-900/60'}`}
                            >
                              {file3d ? (
                                <div className="py-8 flex flex-col items-center text-center px-4">
                                  <div className="w-12 h-12 bg-[#ff9e00]/10 border border-[#ff9e00]/20 rounded-md flex items-center justify-center text-[#ff9e00] mb-3">
                                    <Box className="w-5 h-5" />
                                  </div>
                                  <span className="text-xs font-sans font-medium text-white">{file3d.name}</span>
                                  <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Click to replace</span>
                                </div>
                              ) : editingId && mediaUrl ? (
                                <div className="py-8 flex flex-col items-center text-center px-4">
                                  <div className="w-12 h-12 bg-emerald-500/10 border border-emerald-500/20 rounded-md flex items-center justify-center text-emerald-400 mb-3">
                                    <Check className="w-5 h-5" />
                                  </div>
                                  <span className="text-xs font-sans font-medium text-white">3D File Attached</span>
                                  <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Click to replace file</span>
                                </div>
                              ) : (
                                <div className="py-8 flex flex-col items-center text-center px-4">
                                  <div className="w-12 h-12 bg-zinc-950 border border-white/5 rounded-md flex items-center justify-center text-white/30 mb-3 group-hover/upload:bg-[#ff9e00]/10 group-hover/upload:text-[#ff9e00] group-hover/upload:border-[#ff9e00]/30 transition-all duration-300">
                                    <UploadCloud className="w-5 h-5" />
                                  </div>
                                  <span className="text-xs font-sans font-medium text-white flex items-center gap-2">Select 3D File (.GLB/.GLTF)</span>
                                  <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Max {userPlan === 'SUPREME' ? '100MB' : '50MB'}</span>
                                </div>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-4">
                            <div className="flex gap-1 p-1 bg-zinc-900 border border-white/10 rounded-md w-full sm:max-w-[280px]">
                              <button
                                type="button"
                                onClick={() => setVideoMethod('link')}
                                className={`flex-1 py-2 text-[10px] font-sans font-medium uppercase tracking-wider rounded-md transition-all ${(isBunnyGuid(mediaUrl) ? 'upload' : videoMethod) === 'link' ? 'bg-zinc-800 text-white border border-white/5 shadow-sm' : 'text-white/40 hover:text-white'}`}
                              >
                                Link
                              </button>
                              <button
                                ...
                                className={`flex-1 py-2 text-[10px] font-sans font-medium uppercase tracking-wider rounded-md transition-all flex items-center justify-center gap-1.5 ${(isBunnyGuid(mediaUrl) ? 'upload' : videoMethod) === 'upload' ? 'bg-zinc-800 text-white border border-white/5 shadow-sm' : 'text-white/40 hover:text-white'}`}
                              >
                                ...
                                >
                                  {isUploadingVideo ? (
                                    <div className="w-full px-8 flex flex-col items-center">
                                      ...
                                      <span className="text-[10px] font-sans font-medium text-white/40 uppercase tracking-widest">Uploading... {uploadProgress}%</span>
                                    </div>
                                    ...
                                    <div className="py-8 flex flex-col items-center text-center px-4">
                                      ...
                                      <span className="text-xs font-sans font-medium text-white">Video Successfully Uploaded</span>
                                      <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Click to replace</span>
                                    </div>
                                  ) : (
                                    <div className="py-8 flex flex-col items-center text-center px-4">
                                      ...
                                      <span className="text-xs font-sans font-medium text-white flex items-center gap-2">Upload Video Directly <Crown className="w-3.5 h-3.5 text-[#ff9e00]" /></span>
                                      <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Max {userPlan === 'SUPREME' ? '100MB' : '50MB'} (MP4, WEBM)</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                          ...
                          <div className="w-full">
                            ...
                            <div
                              ...
                              onDragLeave={handleDrag}
                              onDrop={handleDrop}
                              className={`cursor-pointer border border-dashed transition-all duration-300 rounded-md flex flex-col items-center justify-center overflow-hidden relative group/upload min-h-[160px] ${isDragActive ? 'border-[#ff9e00] bg-[#ff9e00]/10 shadow-[0_0_15px_rgba(255,158,0,0.15)]' : 'border-white/10 hover:border-[#ff9e00]/60 bg-zinc-900/30 hover:bg-zinc-900/60'}`}
                            >
                              {isUploadingImage ? (
                                <div className="py-8 flex flex-col items-center text-center px-4">
                                ...
                                <div className="relative w-full h-48 bg-zinc-900">
                                  ...
                                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover/upload:opacity-100 flex items-center justify-center transition-opacity duration-300 backdrop-blur-[2px]">
                                    <span className="bg-zinc-900 border border-white/10 text-white px-4 py-2 rounded-md text-[10px] font-sans font-medium uppercase tracking-wider flex items-center gap-2 shadow-xl">
                                      Change Image
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div className="py-8 flex flex-col items-center text-center px-4">
                                  ...
                                  <span className="text-xs font-sans font-medium text-white">Click to Upload Image</span>
                                  <span className="text-[9px] font-sans font-medium text-white/30 mt-1.5 uppercase tracking-widest">Max {userPlan === 'SUPREME' ? '15MB' : userPlan === 'PRO' ? '10MB' : '5MB'}</span>
                                </div>
                              )}
                            </div>
                          </div>
                      ...
                      {projectType !== 'certificate' && (
                        <div className="md:col-span-2">
                          ...
                          {projectTags.length > 0 && (
                            <div className="flex flex-wrap gap-2 mb-3">
                              {projectTags.map((tag: string) => (
                                <span
                                  key={tag}
                                  className="inline-flex items-center gap-1.5 px-3 py-1 bg-zinc-900 text-[#ff9e00] text-[10px] font-sans font-medium rounded-md border border-white/15"
                                >
                                  {tag}
                                  <button
                                    type="button"
                                    onClick={() => setProjectTags(projectTags.filter((t: string) => t !== tag))}
                                    className="w-3.5 h-3.5 rounded-md bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors leading-none"
                                  >
                          ...
                          <input
                            ...
                            className="w-full px-5 py-3.5 rounded-md border border-white/10 bg-zinc-900 focus:bg-zinc-950 focus:border-[#ff9e00] outline-none text-sm font-sans text-white transition-all duration-300 placeholder:text-white/30 disabled:opacity-40 disabled:cursor-not-allowed"
                          />
                          <p className="text-[9px] font-sans text-white/30 mt-2 ml-1">e.g. UI/UX, Branding, React — Max 5 tags</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="pt-4 flex flex-col-reverse sm:flex-row gap-3 border-t border-white/5 mt-6">
                      {!editingId && (
                        <button
                          ...
                          className="w-full sm:w-auto px-8 py-3.5 rounded-md font-sans font-medium text-white/50 bg-zinc-900 border border-white/10 transition-colors hover:bg-zinc-850 hover:text-white text-xs uppercase tracking-wider"
                        >
                          Back
                        </button>
                      )}
                      <button
                        ...
                        className="w-full sm:flex-1 py-3.5 bg-[#ff9e00] hover:bg-[#ffaa22] text-black rounded-md font-sans font-medium text-xs uppercase tracking-widest active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                      >
