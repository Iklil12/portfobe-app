...
export function EmptyLinks({ state, actions }: EmptyLinksProps) {
  ...
  return (
    <div className="py-20 sm:py-24 flex flex-col items-center justify-center text-center bg-[#050505] rounded-md border border-dashed border-white/10 hover:border-white/20 transition-colors animate-enter" style={{animationDelay: '200ms'}}>
      ...
      <button 
        onClick={addLink} 
        disabled={isAdding}
        className="text-[10px] sm:text-[11px] font-sans font-medium uppercase tracking-widest bg-[#ff9e00] hover:bg-[#ffaa22] text-black px-6 sm:px-8 py-3.5 rounded-md transition-colors shadow-md active:scale-95 flex items-center gap-1.5 disabled:opacity-50"
      >
