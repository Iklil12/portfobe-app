...
export default function PortfolioView({ data, theme, isMobileView = false, isCardPreview = false, isEditor }: { data: any, theme: any, isMobileView?: boolean, isCardPreview?: boolean, isEditor?: boolean }) {
  ...
  // Jika tema yang aktif adalah minimalist, spatial, obsidian-reel, aura-kinetic, editorial, midnight-emulsion, viewfinder, split, monolith, absolute-noir, cinematic, acid, bentogrid, brutalism, cinematic-gallery, layered-monolith, kinetic-avant-garde, nexus-noir, atau horizontal-flow, kita gunakan DynamicBlockRenderer
  if (activeThemeName === 'minimalist' || activeThemeName === 'spatial' || activeThemeName === 'obsidian-reel' || activeThemeName === 'aura-kinetic' || activeThemeName === 'editorial' || activeThemeName === 'midnight-emulsion' || activeThemeName === 'viewfinder' || activeThemeName === 'split' || activeThemeName === 'monolith' || activeThemeName === 'absolute-noir' || activeThemeName === 'cinematic' || activeThemeName === 'acid' || activeThemeName === 'acid-tech' || activeThemeName === 'bentogrid' || activeThemeName === 'brutalism' || activeThemeName === 'cinematic-gallery' || activeThemeName === 'layered-monolith' || activeThemeName === 'kinetic-avant-garde' || activeThemeName === 'nexus-noir' || activeThemeName === 'horizontal-flow') {
    return (
