      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-black items-center justify-center p-16 overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <h2 className="text-4xl font-display font-bold text-white leading-tight tracking-tight mb-6">
            {t('prestigeHeadline1')} <br /> <span className="text-[#ff9e00] font-mono text-xl tracking-wider uppercase block mt-3">{t('prestigeHeadline2')}</span>
          </h2>
          ...
          <div className="mt-24 pt-12 border-t border-white/15 flex items-center gap-5">
            ...
            <div>
               <p className="text-xs font-mono font-bold text-white tracking-wide">{t('creatorsCount')}</p>
               <p className="text-[10px] font-mono text-white/40">{t('creatorsJoined')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[55%] bg-[#050505] flex flex-col justify-center px-6 sm:px-16 md:px-24 xl:px-40 relative z-10">
        ...
        <div className="w-full max-w-md mx-auto py-12 mt-12 lg:mt-0 relative z-10">
          <div className="mb-10 text-left">
             ...
             <p className="text-white/40 text-xs font-mono mt-2">{t('description')}</p>
          </div>
          ...
          {otpSentTo ? (
            <form onSubmit={handleVerifyOtp} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              >
                <div className={`flex items-center justify-center gap-2 transition-opacity duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
                  {t('verifyContinue')} <ArrowRight className="w-4 h-4" />
                </div>
                {isLoading && (
            ...
            <div className="group">
              <label className="block text-[9px] font-mono font-bold uppercase tracking-widest text-white/45 mb-2 group-focus-within:text-[#ff9e00] transition-colors">{t('fullNameLabel')}</label>
              <input 
                name="fullName" 
                type="text" 
            ...
            <div className="group">
              <label className="block text-[9px] font-mono font-bold uppercase tracking-widest text-white/45 mb-2 group-focus-within:text-[#ff9e00] transition-colors">{t('passwordLabel')}</label>
            ...
            >
              <div className={`flex items-center justify-center gap-2 transition-opacity duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
                {t('registerButton')} <ArrowRight className="w-4 h-4" />
              </div>
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-4 text-[9px] font-mono font-bold text-white/20 uppercase tracking-widest">{t('orRegisterWith')}</span>
            <div className="flex-grow border-t border-white/5"></div>
          </div>
          ...
          <p className="text-center text-xs text-white/40 mt-10 font-mono">
            {t('hasAccount')} <Link href="/login" className="text-white font-bold hover:text-[#ff9e00] transition-colors ml-1 uppercase tracking-wider">{t('loginNow')}</Link>
          </p>
            </>
          )}
        </div>
