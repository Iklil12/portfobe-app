  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[320px] md:max-w-[400px] mx-auto bg-zinc-950 border border-white/10 rounded-md shadow-[0_45px_100px_rgba(0,0,0,0.9)] p-6 md:p-8 flex flex-col text-center">
        ...
        <h3 className="text-base md:text-lg font-sans font-medium uppercase tracking-wider text-white mb-2">Move to Trash?</h3>
        <p className="text-xs font-sans text-white/50 mb-6 leading-relaxed px-1">
          This item will be moved to the <strong className="text-[#ff9e00] font-medium">Trash</strong> and permanently deleted after <strong className="text-[#ff9e00] font-medium">30 days</strong>. You can restore it anytime before then.
        </p>
