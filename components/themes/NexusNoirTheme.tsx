            ...
            <section id="about" className="py-32 px-6 relative z-20">
                <div className="max-w-7xl mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[220px]">
                        ...
                        {/* Cell 1 */}
                        <div className="glass-panel rounded-3xl p-8 flex flex-col justify-between md:col-span-2 gs-reveal hover:-translate-y-1 transition-transform duration-300 cursor-default">
                        ...
                        {/* Cell 2 */}
                        <div className="glass-panel rounded-3xl p-8 flex flex-col justify-end gs-reveal hover:-translate-y-1 transition-transform duration-300 md:col-span-1 border-t-4" style={{ borderTopColor: accentColor }}>
                        ...
                        {/* Cell 3 */}
                        <div className="glass-panel rounded-3xl p-8 flex flex-col justify-between gs-reveal hover:-translate-y-1 transition-transform duration-300 md:col-span-1">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {(data?.skills || []).slice(0, 5).map((skill: any, i: number) => (
                                    <span key={i} className="bg-white/5 px-3 py-1 rounded-full text-[10px] uppercase tracking-wider text-white border border-white/10">{skill.name}</span>
                                ))}
                                {(!data?.skills || data.skills.length === 0) && (
                                    <>
                                        <span className="bg-white/5 px-3 py-1 rounded-full text-[10px] uppercase tracking-wider text-white border border-white/10">Figma</span>
                                        <span className="bg-white/5 px-3 py-1 rounded-full text-[10px] uppercase tracking-wider text-white border border-white/10">React</span>
                                    </>
                                )}
                            </div>
                        </div>
                        ...
                        {/* Cell 4 */}
                        <div className="glass-panel rounded-3xl p-8 flex flex-col justify-between md:col-span-4 relative overflow-hidden gs-reveal group hover:-translate-y-1 transition-transform duration-300">
